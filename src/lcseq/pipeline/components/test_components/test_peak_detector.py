# src/lcseq/pipeline/components/test_components/test_peak_detector.py
import logging
...
class TestPeakDetector(PipelineComponent):
    def process_peptide(self, input_data: SinglePeptideInput) -> SinglePeptideInput:
        # Detect peaks for a single peptide
    ...
    def process_peptide_set(self, input_data: PeptideSetInput) -> PeptideSetInput:
        # Detect peaks for a set of peptides
    ...
    def process_hierarchy(self, input_data: PeptideHierarchyInput) -> PeptideHierarchyInput:
        # Detect peaks for a hierarchy of peptides
